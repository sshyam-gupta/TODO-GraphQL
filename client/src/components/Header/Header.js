	...
	render () {
		return (
			<header className="bg-white black-80 tc pv4 avenir">
				...
				<h2 className="mt2 mb0 f6 fw4 ttu tracked">Your amazing graphql todo</h2>
				<nav className="bt bb tl mt4">
					<Link className="f6 f5-l link bg-animate black-80 hover-bg-lightest-blue dib pa3 ph4-l" to="/">List</Link>
					{/* <a className="f6 f5-l link bg-animate black-80 hover-bg-light-green dib pa3 ph4-l" href="/portfolio">Portfolio</a> */}
					<Link className="f6 f5-l link bg-animate black-80 hover-bg-light-yellow dib pa3 ph4-l" to="/add">Add</Link>
